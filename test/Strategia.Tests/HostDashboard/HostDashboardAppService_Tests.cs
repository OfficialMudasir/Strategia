...
using Strategia.MultiTenancy.HostDashboard;
...
namespace Strategia.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(StrategiaDbContext context, SubscriptionPayment subscriptionPayment)
        {
