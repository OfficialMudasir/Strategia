...
using Strategia.Services.Navigation;
using Microsoft.AspNetCore.Components;
using Strategia.Mobile.MAUI.Services.Account;
using Strategia.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using Strategia.Mobile.MAUI.Services.Tenants;

#if ANDROID
using Strategia.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace Strategia.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new Strategia.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
