...
namespace Strategia.Organizations
{
    public class UserOrganizationUnitRepository : StrategiaRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<StrategiaDbContext> dbContextProvider)
