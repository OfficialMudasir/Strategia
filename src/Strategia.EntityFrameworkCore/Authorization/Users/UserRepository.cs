...
{
    public class UserRepository : StrategiaRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<StrategiaDbContext> dbContextProvider)
