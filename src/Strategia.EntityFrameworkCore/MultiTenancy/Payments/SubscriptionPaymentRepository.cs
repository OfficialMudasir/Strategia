...
{
    public class SubscriptionPaymentRepository : StrategiaRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<StrategiaDbContext> dbContextProvider)
