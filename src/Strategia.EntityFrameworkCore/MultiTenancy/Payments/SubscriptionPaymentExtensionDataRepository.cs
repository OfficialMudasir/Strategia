...
using Strategia.EntityFrameworkCore.Repositories;

namespace Strategia.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : StrategiaRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<StrategiaDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
