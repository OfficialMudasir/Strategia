...
namespace Strategia.Migrations
{
    ...
    [Migration("20231214030513_Added_Course_Author")]
    partial class Added_Course_Author
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Strategia.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Strategia.Authorization.Users.RecentPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Strategia.Courses.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("AuthorProfilePictureId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("SkillsOverview")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("strCourses");
                });

            modelBuilder.Entity("Strategia.Courses.CourseLesson", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("strCourseLessons");
                });

            modelBuilder.Entity("Strategia.Courses.CourseLessonActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("TitleVideoDuration")
                    ...
                    b.ToTable("strCourseLessonActivities");
                });

            modelBuilder.Entity("Strategia.Courses.CourseUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("CourseCompletedTotal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<Guid?>("CourseId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("CourseLessonActivityCompletedTotal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<Guid?>("CourseLessonActivityId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("CourseLessonActivityTotal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CourseLessonCompletedTotal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<Guid?>("CourseLessonId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("CourseLessonTotal")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("CourseLessonActivityId");
            ...
            modelBuilder.Entity("Strategia.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Strategia.UserProfiles.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ChatGPTRecommendation")
                        .HasMaxLength(262144)
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("CurrentSalaryBandHigh")
                        .HasColumnType("int");

                    b.Property<int>("CurrentSalaryBandLow")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PreferredSalaryBandHigh")
                        .HasColumnType("int");

                    b.Property<int>("PreferredSalaryBandLow")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Strategia.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Strategia.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Strategia.Courses.Course", b =>
                {
                    b.HasOne("Strategia.Authorization.Users.User", "UserFk")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("Strategia.Courses.CourseLesson", b =>
                {
                    b.HasOne("Strategia.Courses.Course", "CourseFk")
                        .WithMany("LessonsFk")
            ...
            modelBuilder.Entity("Strategia.Courses.CourseLessonActivity", b =>
                {
                    b.HasOne("Strategia.Courses.CourseLesson", "CourseLessonFk")
                        .WithMany("ActivityFk")
                        .HasForeignKey("CourseLessonId");

                    b.Navigation("CourseLessonFk");
                });
            ...
            modelBuilder.Entity("Strategia.Courses.CourseUser", b =>
                {
                    ...
                    b.HasOne("Strategia.Courses.CourseLessonActivity", "CourseLessonActivityFk")
                        .WithMany()
                        .HasForeignKey("CourseLessonActivityId");

                    b.HasOne("Strategia.Courses.CourseLesson", "CourseLessonFk")
                        .WithMany()
                        .HasForeignKey("CourseLessonId");

                    b.HasOne("Strategia.UserProfiles.UserProfile", "UserProfileFk")
                        .WithMany()
                        .HasForeignKey("UserProfileId");

                    b.Navigation("CourseFk");

                    b.Navigation("CourseLessonActivityFk");
