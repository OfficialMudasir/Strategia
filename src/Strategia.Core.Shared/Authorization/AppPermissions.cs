namespace Strategia.Authorization
{
    ...
    {
        public const string Pages_CourseUsers = "Pages.CourseUsers";
        public const string Pages_CourseUsers_Create = "Pages.CourseUsers.Create";
        public const string Pages_CourseUsers_Edit = "Pages.CourseUsers.Edit";
        public const string Pages_CourseUsers_Delete = "Pages.CourseUsers.Delete";

        public const string Pages_CourseLessonActivities = "Pages.CourseLessonActivities";
        public const string Pages_CourseLessonActivities_Create = "Pages.CourseLessonActivities.Create";
        public const string Pages_CourseLessonActivities_Edit = "Pages.CourseLessonActivities.Edit";
        public const string Pages_CourseLessonActivities_Delete = "Pages.CourseLessonActivities.Delete";

        public const string Pages_CourseLessons = "Pages.CourseLessons";
        public const string Pages_CourseLessons_Create = "Pages.CourseLessons.Create";
        public const string Pages_CourseLessons_Edit = "Pages.CourseLessons.Edit";
        public const string Pages_CourseLessons_Delete = "Pages.CourseLessons.Delete";

        public const string Pages_Courses = "Pages.Courses";
        public const string Pages_Courses_Create = "Pages.Courses.Create";
        public const string Pages_Courses_Edit = "Pages.Courses.Edit";
        public const string Pages_Courses_Delete = "Pages.Courses.Delete";

        public const string Pages_UserProfiles = "Pages.UserProfiles";
        public const string Pages_UserProfiles_Create = "Pages.UserProfiles.Create";
        public const string Pages_UserProfiles_Edit = "Pages.UserProfiles.Edit";
        public const string Pages_UserProfiles_Delete = "Pages.UserProfiles.Delete";
