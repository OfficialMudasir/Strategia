namespace Strategia
{
    public class StrategiaDashboardCustomizationConsts
    {
        /// <summary>
        ...
        public class Widgets
        {
            public class Tenant
            {
                ...
                //STQ MODIFIED
                public const string CourseActivity = "Widgets_Course_Activity";
                public const string CourseRecommendations = "Widgets_Course_Recommendations";
                public const string CourseReport = "Widgets_Course_Report";
                public const string Profile = "Widgets_Profile";
