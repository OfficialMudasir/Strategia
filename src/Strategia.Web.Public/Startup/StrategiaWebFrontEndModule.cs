...
namespace Strategia.Web.Public.Startup
{
    [DependsOn(
        typeof(StrategiaWebCoreModule)
    )]
    public class StrategiaWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public StrategiaWebFrontEndModule(IWebHostEnvironment env, StrategiaEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(StrategiaWebFrontEndModule).GetAssembly());
        }
    }
}
