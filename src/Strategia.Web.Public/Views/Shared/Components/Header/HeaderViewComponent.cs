...
using Strategia.Url;
using Strategia.Web.Public.Startup;
using Strategia.Web.Session;
using Strategia.Web.UiCustomization;

namespace Strategia.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : StrategiaViewComponent
    {
