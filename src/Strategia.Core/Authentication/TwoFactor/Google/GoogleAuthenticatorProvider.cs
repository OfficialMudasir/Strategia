...
namespace Strategia.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : StrategiaServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Strategia", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
