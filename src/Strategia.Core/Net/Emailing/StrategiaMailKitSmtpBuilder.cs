...
{
    public class StrategiaMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public StrategiaMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(StrategiaConsts.LocalizationSourceName, name);
        }
    }
}