...
using Strategia.Authentication;
using Strategia.DashboardCustomization;
...
namespace Strategia.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!StrategiaConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        StrategiaConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        StrategiaDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        StrategiaDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = StrategiaDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page
                    {
                        Name = StrategiaDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = StrategiaDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    StrategiaDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = StrategiaDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page
                    {
                        ...
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = StrategiaDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    StrategiaDashboardCustomizationConsts.Widgets.Tenant
