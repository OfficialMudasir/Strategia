...
namespace Strategia.Authorization.Users
{
    ...
    /// </summary>
    public class UserEmailer : StrategiaServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        public async Task SendPasswordResetLinkAsync(User user, string link = null)
        {
            ...
            if (!link.IsNullOrEmpty())
            {
                ...
                var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours).ToString(StrategiaConsts.DateTimeOffsetFormat));
