...
namespace Strategia.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var courseUsers = pages.CreateChildPermission(AppPermissions.Pages_CourseUsers, L("CourseUsers"));
            courseUsers.CreateChildPermission(AppPermissions.Pages_CourseUsers_Create, L("CreateNewCourseUser"));
            courseUsers.CreateChildPermission(AppPermissions.Pages_CourseUsers_Edit, L("EditCourseUser"));
            courseUsers.CreateChildPermission(AppPermissions.Pages_CourseUsers_Delete, L("DeleteCourseUser"));

            var courseLessonActivities = pages.CreateChildPermission(AppPermissions.Pages_CourseLessonActivities, L("CourseLessonActivities"));
            courseLessonActivities.CreateChildPermission(AppPermissions.Pages_CourseLessonActivities_Create, L("CreateNewCourseLessonActivity"));
            courseLessonActivities.CreateChildPermission(AppPermissions.Pages_CourseLessonActivities_Edit, L("EditCourseLessonActivity"));
            courseLessonActivities.CreateChildPermission(AppPermissions.Pages_CourseLessonActivities_Delete, L("DeleteCourseLessonActivity"));

            var courseLessons = pages.CreateChildPermission(AppPermissions.Pages_CourseLessons, L("CourseLessons"));
            courseLessons.CreateChildPermission(AppPermissions.Pages_CourseLessons_Create, L("CreateNewCourseLesson"));
            courseLessons.CreateChildPermission(AppPermissions.Pages_CourseLessons_Edit, L("EditCourseLesson"));
            courseLessons.CreateChildPermission(AppPermissions.Pages_CourseLessons_Delete, L("DeleteCourseLesson"));

            var courses = pages.CreateChildPermission(AppPermissions.Pages_Courses, L("Courses"));
            courses.CreateChildPermission(AppPermissions.Pages_Courses_Create, L("CreateNewCourse"));
            courses.CreateChildPermission(AppPermissions.Pages_Courses_Edit, L("EditCourse"));
            courses.CreateChildPermission(AppPermissions.Pages_Courses_Delete, L("DeleteCourse"));

            var userProfiles = pages.CreateChildPermission(AppPermissions.Pages_UserProfiles, L("UserProfiles"));
            userProfiles.CreateChildPermission(AppPermissions.Pages_UserProfiles_Create, L("CreateNewUserProfile"));
            userProfiles.CreateChildPermission(AppPermissions.Pages_UserProfiles_Edit, L("EditUserProfile"));
            userProfiles.CreateChildPermission(AppPermissions.Pages_UserProfiles_Delete, L("DeleteUserProfile"));
        ...
        {
            return new LocalizableString(name, StrategiaConsts.LocalizationSourceName);
        }
    }
}