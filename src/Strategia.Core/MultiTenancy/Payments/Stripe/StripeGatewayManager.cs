...
{
    public class StripeGatewayManager : StrategiaServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Strategia";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + StrategiaConsts.Currency;
        }
