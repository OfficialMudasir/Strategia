...
using Strategia.Authorization.Ldap;
using Strategia.Authorization.Roles;
using Strategia.Authorization.Users;
using Strategia.Chat;
using Strategia.Configuration;
using Strategia.DashboardCustomization.Definitions;
using Strategia.Debugging;
using Strategia.DynamicEntityProperties;
using Strategia.Features;
using Strategia.Friendships;
using Strategia.Friendships.Cache;
using Strategia.Localization;
using Strategia.MultiTenancy;
using Strategia.Net.Emailing;
using Strategia.Notifications;
using Strategia.WebHooks;
using Newtonsoft.Json;

namespace Strategia
{
    [DependsOn(
        typeof(StrategiaCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class StrategiaCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            StrategiaLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = StrategiaConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, StrategiaMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<StrategiaSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(StrategiaCoreModule).GetAssembly());
        }
