...
using Strategia.Authorization.Users.Password;
using Strategia.Configuration;
using Strategia.EntityFrameworkCore;
using Strategia.MultiTenancy;
using Strategia.Web.Startup.ExternalLoginInfoProviders;
...
namespace Strategia.Web.Startup
{
    ...
    public class StrategiaWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public StrategiaWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(StrategiaWebHostModule).GetAssembly());
        }
