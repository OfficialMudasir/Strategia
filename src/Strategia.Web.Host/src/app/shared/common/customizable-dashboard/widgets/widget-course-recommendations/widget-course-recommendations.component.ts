...
@Component({
    selector: 'app-widget-course-recommendations.component',
    templateUrl: './widget-course-recommendations.component.html',
    styleUrls: ['./widget-course-recommendations.component.css'],
})
export class WidgetCourseRecommendationsComponent extends WidgetComponentBaseComponent implements OnInit {
