...
import { WidgetCourseActivityComponent } from './widgets/widget-course-activity/widget-course-activity.component';
import { WidgetProfileComponent } from './widgets/widget-profile/widget-profile.component';
import { WidgetCourseRecommendationsComponent } from './widgets/widget-course-recommendations/widget-course-recommendations.component';
import { WidgetCourseReportComponent } from './widgets/widget-course-report/widget-course-report.component';
...
export class DashboardViewConfigurationService {
    ...
    private initializeConfiguration() {
        ...
        // STQ MODIFIED
        let courseActivity = new WidgetViewDefinition(
            DashboardCustomizationConst.widgets.tenant.courseActivity,
            WidgetCourseActivityComponent
        );
        this.WidgetViewDefinitions.push(courseActivity);

        let courseRecommendations = new WidgetViewDefinition(
            DashboardCustomizationConst.widgets.tenant.courseRecommendations,
            WidgetCourseRecommendationsComponent
        );
        this.WidgetViewDefinitions.push(courseRecommendations);

        let report = new WidgetViewDefinition(
            DashboardCustomizationConst.widgets.tenant.courseReport,
            WidgetCourseReportComponent
        );
        this.WidgetViewDefinitions.push(report);

        let profile = new WidgetViewDefinition(
            DashboardCustomizationConst.widgets.tenant.profile,
            WidgetProfileComponent
        );
        this.WidgetViewDefinitions.push(profile);
