...
using Strategia.Core.Base;
using Strategia.Core.Extensions;
using Strategia.Dto;
using Strategia.Types;

namespace Strategia.Queries
{
    public class OrganizationUnitQuery : StrategiaQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
