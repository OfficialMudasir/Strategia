...
namespace Strategia.Core.Base
{
    public abstract class StrategiaQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected StrategiaQueryBase(string fieldName,
