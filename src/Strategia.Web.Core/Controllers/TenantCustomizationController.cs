...
using Strategia.Tenants;

namespace Strategia.Web.Controllers
{
    [AbpMvcAuthorize]
    public class TenantCustomizationController : StrategiaControllerBase
    {
        ...
        [AllowAnonymous]
        public async Task<ActionResult> GetTenantLogo(string skin, int? tenantId, string extension = "png")
        {
