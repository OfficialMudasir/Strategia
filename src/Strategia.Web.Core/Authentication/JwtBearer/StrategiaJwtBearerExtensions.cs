...
/// </summary>
public static class StrategiaJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, StrategiaAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
