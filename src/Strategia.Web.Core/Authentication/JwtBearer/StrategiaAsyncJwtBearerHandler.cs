...
{
    public class StrategiaAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public StrategiaAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
