...
using Strategia.UiCustomization;
...
{
    public class SessionAppService : StrategiaAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = StrategiaConsts.Currency,
                        CurrencySign = StrategiaConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = StrategiaConsts.AllowTenantsToChangeEmailSettings,
