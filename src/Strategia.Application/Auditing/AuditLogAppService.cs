...
using Strategia.Auditing.Exporting;
using Strategia.Authorization;
using Strategia.Authorization.Users;
using Strategia.Dto;
using Strategia.EntityHistory;
using EntityHistoryHelper = Strategia.EntityHistory.EntityHistoryHelper;

namespace Strategia.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : StrategiaAppServiceBase, IAuditLogAppService
    {
