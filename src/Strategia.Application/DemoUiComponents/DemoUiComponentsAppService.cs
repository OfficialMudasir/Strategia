...
using Strategia.DemoUiComponents.Dto;

namespace Strategia.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : StrategiaAppServiceBase, IDemoUiComponentsAppService
    {
