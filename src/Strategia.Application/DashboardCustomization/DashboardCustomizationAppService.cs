...
using Strategia.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Strategia.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : StrategiaAppServiceBase, IDashboardCustomizationAppService
    {
