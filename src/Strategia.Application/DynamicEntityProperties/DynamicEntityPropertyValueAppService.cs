...
using Strategia.DynamicEntityPropertyValues.Dto;

namespace Strategia.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : StrategiaAppServiceBase, IDynamicEntityPropertyValueAppService
    {
